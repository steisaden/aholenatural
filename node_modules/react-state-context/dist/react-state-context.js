(function (global, factory) {
	...
	(global.createStateContext = factory(global.React));
	...
	*/
	...
	function warning$2(message, code) {
	...
	function createStateContext() {
	  ...
	  if (!isValidState(initialState)) {
	    {
	      warning$2('Warning: StateContext state must be an object or null. You passed an invalid value to createStateContext' + ' that has been ignored.', 'INVALID_INITIAL_STATE');
	    }
	  } else {
...

	  {
	    if (actions && (typeof actions === 'undefined' ? 'undefined' : _typeof(actions)) !== 'object' || Array.isArray(actions)) {
	      warning$2('You passed invalid actions to createStateContext. actions must be an object.', 'INVALID_ACTIONS_ARGUMENT');
	    }
	  }

	  var ProviderComponent = function (_Component) {
	    inherits(ProviderComponent, _Component);
	    createClass(ProviderComponent, [{
	      key: 'render',
	      value: function render() {
	        var children = this.props.children;


	        return React__default.createElement(Context.Provider, { value: this.state, children: children });
	      }
	    }]);
	    ...
	    function ProviderComponent() {
	      ...
	      classCallCheck(this, ProviderComponent);

	      var _this = possibleConstructorReturn(this, (_ref = ProviderComponent.__proto__ || Object.getPrototypeOf(ProviderComponent)).call.apply(_ref, [this].concat(args)));
	      ...
	      _this.onAction = function (returnValue) {
	        ...
	        // the setState wrapper.
	          ...
	          // If it not undefined, nor a function, nor valid, then we log a warning and do nothing.
	              ...
	              {
	                warning$2('Warning: StateContext actions must update state to an object or null. You called an action that' + ' set an invalid value. This value has been ignored, and the state has not been updated.', 'INVALID_ACTION_UPDATE');
	              }
	      ...
	      var _loop = function _loop(key) {
	        ...
	        if (typeof action !== 'function') {
	          {
	            warning$2('Warning: an action with key ' + key + ' was passed to createStateContext that was not a function. Actions' + (' must be functions. The ' + key + ' action has been ignored. You should check your call to createStateContext().'), 'ACTION_MUST_BE_FN');
	          }
	        ...
	        if (key === 'state') {
	          {
	            warning$2('Warning: an action was passed to createStateContext with the key "state". This is a reserved key,' + ' so your action has been ignored.', 'INVALID_ACTION_KEY');
	          }
